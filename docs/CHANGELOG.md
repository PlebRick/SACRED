...
### Fixed
- **DOM Nesting Validation**: Resolved React warning for button nested inside button
  - SeriesSelector and TopicSelector now use `div[role="button"]` for trigger
  - Added keyboard handling (Enter/Space) for accessibility
